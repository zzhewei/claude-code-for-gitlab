...
router.post('/projects/:projectId/disable', requireAuth, async (req: Request, res: Response) => {
  const gitlabProjectId = parseInt(req.params.projectId);
...
router.put('/projects/:projectId/settings', requireAuth, async (req: Request, res: Response) => {
  const gitlabProjectId = parseInt(req.params.projectId);
